...
public class NoCrashHandler
{
    ...
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "com.ommne.EXTRA_RESTART_ACTIVITY_CLASS";


    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.ommne.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.ommne.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.ommne";
